...
| 文件 | 内容 |
| --- | --- |
| `reports/YYYY-MM-DD-morning.md` / `-evening.md` | 早报/晚报：信源健康表 + AI 报告（今日风向 / **社会现象观察** / 机会信号 / 值得关注的人·品牌·事件 / 今日不必深挖）+ 各平台原始榜单附录（英文源附中文译名） |
| `data/YYYY-MM-DD-morning.json` / `-evening.json` | 当日抓取的原始结构化数据（供日后复盘分析） |
| `reports/YYYY-MM-DD-weekly.md` | 每周日 21:00 生成：本周核心趋势 / 连续出现的信号 / 本周值得记住（带原文链接）/ 下周看点 / 社会观察小结 + **尾版简讯**（未精选热点，带链接） |
